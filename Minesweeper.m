...
h_flagbox = uicontrol( 'FontSize',18,'FontWeight','bold',...
        'Position',[squ_size squ_size*N*1.07 squ_size*N/10 squ_size],...
...
uicontrol( 'FontSize',18,'FontWeight','bold',...
        'Position',[squ_size*N/2 squ_size*N*1.07 squ_size*N/5 squ_size],...
        'Style','pushbutton','Tag',num2str(counter),'string', 'New',...
